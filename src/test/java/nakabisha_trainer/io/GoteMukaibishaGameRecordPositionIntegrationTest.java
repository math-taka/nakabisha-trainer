...
class GoteMukaibishaGameRecordPositionIntegrationTest {
    ...
    void reproducesPositionAfterTwentyMoves() throws Exception {
        ...
        assertEquals(PieceType.HI, position.pieceAt(new Square(2, 8)).type());
        assertEquals(Side.SENTE, position.pieceAt(new Square(2, 8)).side());
        assertEquals(PieceType.HI, position.pieceAt(new Square(2, 8)).type());
        ...
        assertEquals(PieceType.GIN, position.pieceAt(new Square(6, 1)).type());
        ...
        assertEquals(1, position.hand(Side.SENTE).count(PieceType.FU));
