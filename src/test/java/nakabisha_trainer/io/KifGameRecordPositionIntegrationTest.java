...
class KifGameRecordPositionIntegrationTest {
    ...
    void reproducesPositionAfterTwentyMoves() throws Exception {
        ...
        assertEquals(Side.SENTE, position.pieceAt(new Square(5, 6)).side());
        assertEquals(PieceType.FU, position.pieceAt(new Square(5, 6)).type());
        assertEquals(Side.SENTE, position.pieceAt(new Square(5, 8)).side());
        assertEquals(PieceType.HI, position.pieceAt(new Square(5, 8)).type());
        ...
        assertEquals(PieceType.OU, position.pieceAt(new Square(3, 8)).type());
        assertEquals(Side.SENTE, position.pieceAt(new Square(5, 7)).side());
        assertEquals(PieceType.GIN, position.pieceAt(new Square(5, 7)).type());

        assertEquals(Side.GOTE, position.pieceAt(new Square(3, 5)).side());
        assertEquals(PieceType.FU, position.pieceAt(new Square(3, 5)).type());
        assertEquals(Side.GOTE, position.pieceAt(new Square(3, 2)).side());
        assertEquals(PieceType.HI, position.pieceAt(new Square(3, 2)).type());
        ...
        assertEquals(Side.GOTE, position.pieceAt(new Square(5, 4)).side());
        assertEquals(PieceType.FU, position.pieceAt(new Square(5, 4)).type());
