...
class GameRecordTest {
    ...
    void addsAndReturnsMoves() {
        GameRecord record = new GameRecord();
        Move move = new Move(new Square(7, 7), new Square(7, 6), PieceType.FU, false);
    ...
    void returnsPositionAtRequestedPly() {
        GameRecord record = new GameRecord();
        Move firstMove = new Move(new Square(7, 7), new Square(7, 6), PieceType.FU, false);
        Move secondMove = new Move(new Square(3, 3), new Square(3, 4), PieceType.FU, false);
        ...
        assertEquals(new Piece(Side.SENTE, PieceType.FU, false),
                initial.pieceAt(new Square(7, 7)));
        assertEquals(new Piece(Side.SENTE, PieceType.FU, false),
                afterFirst.pieceAt(new Square(7, 6)));
        assertEquals(new Piece(Side.GOTE, PieceType.FU, false),
                afterFirst.pieceAt(new Square(3, 3)));
        assertEquals(new Piece(Side.GOTE, PieceType.FU, false),
                afterSecond.pieceAt(new Square(3, 4)));
    }
    ...
    void currentPositionIsPositionAfterAllMoves() {
        ...
        assertEquals(record.positionAt(1).board()[new Square(7, 6).index()],
                record.currentPosition().board()[new Square(7, 6).index()]);
